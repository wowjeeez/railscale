...
impl ForwardHttpsToHttp {
    ...
    pub fn builder() -> ForwardHttpsToHttpBuilder {
        ForwardHttpsToHttpBuilder {
            bind_addr: None,
            upstream: None,
            tls_config: None,
            buffer_limits: BufferLimits::default(),
...
pub struct ForwardHttpsToHttpBuilder {
...
impl ForwardHttpsToHttpBuilder {
    ...
    pub async fn build(self) -> Result<ForwardHttpsToHttp, RailscaleError> {
